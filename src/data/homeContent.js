...
export const technologyLogoGrid = [
  ...
  { name: 'Amazon DynamoDB', logo: devicon('amazonwebservices') },
  ...
  { name: 'Adobe XD', logo: devicon('xd') },
  { name: 'Adobe Illustrator', logo: devicon('illustrator') },
  { name: 'Adobe Photoshop', logo: devicon('photoshop') },
  { name: 'Adobe Premiere Pro', logo: devicon('premierepro') },
  { name: 'Google Cloud', logo: devicon('googlecloud') },
  { name: 'AWS', logo: '/logos/aws.svg' },
  { name: 'MongoDB', logo: devicon('mongodb') },
  { name: 'Microsoft Azure', logo: devicon('azure') },
  { name: 'DigitalOcean', logo: devicon('digitalocean') },
